...
import MobileMinigameCard from "@/components/DesktopMinigameCard";
import { CategoryType } from "@/lib/games-api";
import MobileGameDropdown from "./DesktopGameDropdown";
...
export default function DesktopMinigamesClient({ cards, categories }: Props) {
