...
export default function MobilePointsTable({
  seasons,
  sortedSeasons,
  seasonId,
  onSeasonChange,
  ...
  return (
    <div className="" key={`points-${seasonId}`}>
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-800/90 via-slate-900/90 to-slate-800/90 rounded-t-2xl p-3 border border-amber-400/30 border-b-0 backdrop-blur-xl">
            ...
            {seasons.length > 0 && (
              <div className="">
                <select
                  ...
                  className="bg-slate-900/80 backdrop-blur-sm text-amber-200 rounded-lg px-4 py-2 text-sm font-medium hover:bg-slate-800/80 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-400/50 cursor-pointer"
                >
