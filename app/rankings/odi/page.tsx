    ...
    <>
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 overflow-visible">
          <div className="space-y-6 2xl:w-[75%] xl:w-[80%] lg:w-[95%] mx-auto px-4 py-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {men.length > 0 ? (
                ...
                <div className="text-center">No men's rankings available</div>
              )}
              ...
              {women.length > 0 ? (
                ...
                <div className="text-center">No women's rankings available</div>
              )}
            </div>
          </div>
        </main>
