...
interface RankingTeam {
    ...
    code: string
    image_path: string
    ranking: { position: number; matches: number; points: number; rating: number }
}
...
export default function T20IRankingsPage() {
    ...
    if (error) {
        return <div className="card">Failed to load team rankings.{typeof error === 'string' ? ` ${error}` : ''}</div>
    }
    if (isLoading) {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex gap-2 mb-4">
                ...
                <Link href="/rankings/t20i" className="px-4 py-2 rounded-md font-medium text-white bg-blue-600">T20I</Link>
                <Link href="/rankings/test" className="px-4 py-2 rounded-md font-medium text-blue-600 bg-gray-100 hover:bg-gray-200">T20I</Link>
