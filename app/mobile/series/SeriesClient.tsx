                ...
                <div className="flex justify-center overflow-x-auto">
                  {SERIES_TABS.map((tab) => (
                    <button
                      ...
                      className={`px-6 py-3 text-sm font-medium whitespace-nowrap border-b transition-colors  ${
                        activeTab === tab.id
                ...
                <>
                  ...
                  <div className="rounded-3xl border border-amber-400/40 bg-gradient-to-br from-slate-900/90 via-amber-900/20 to-orange-900/30 px-6 py-5 shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="flex  items-center ">
                      <h1 className="mt-2 m-h">Series & Leagues</h1>
                    </div>
