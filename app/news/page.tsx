...
/* ------------------ SHARE ICONS (your existing code) ------------------ */
...
function ShareModal({
  ...
  function onWhatsappStatus() {
    setToast(
      "WhatsApp Status can't be opened with a prefilled link. Use Copy link and paste into Status.",
    );
      ...
      {numbers.map((p) => (
        <button
          ...
          className={`px-4 py-2 rounded-xl border border-white/10 transition ${
            p === page
              ? "bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500 text-black font-semibold"
                  ...
                  {articles.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h2 className="text-xl font-semibold mb-2 text-slate-100 group-hover:text-amber-300 transition-colors duration-300">
                          <Link
                            href={`/news/${item.slug}`}
                        ...
                        <div className="mt-4 flex items-center justify-between gap-3">
                          <Link
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg
                                       ...
                                       transition-all duration-300 hover:brightness-110 hover:shadow-xl hover:shadow-amber-500/40"
                          >
                            Read more{" "}
