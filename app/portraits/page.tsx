                                ...
                                {cards.map((p) => (
                                    ...
                                    >
                                        {p._cover ? (
                                            ...
                                            <img src={p._cover} alt={p.title} className="h-44 w-full object-cover" loading="lazy" />
                                        ) : (
                                        ...
                                        <div className="p-5">
                                            ...
                                            {p.subtitle ? <div className="mt-1 text-sm text-white/60">{p.subtitle}</div> : null}
                                            <div className="mt-4 text-xs text-white/60">Click to view details →</div>
                                        </div>
                                    </Link>
                                ))}
                            </div>
