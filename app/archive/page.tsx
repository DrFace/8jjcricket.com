    ...
    return (
      <>
        ...
        <div className="min-h-[60vh] flex flex-col gap-6">
          {/* Dark hero */}
          <div className="rounded-3xl border border-white/15 bg-gradient-to-r from-black/70 via-slate-900/80 to-amber-900/40 px-6 py-5 shadow-2xl backdrop-blur-xl">
