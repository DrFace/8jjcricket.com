    ...
    <div className="pointer-events-none absolute inset-0 hidden lg:block">
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: "screen",
          opacity: 0.55,
          WebkitMaskImage: "linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 55%, rgba(0,0,0,0) 100%)",
          maskImage: "linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 55%, rgba(0,0,0,0) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          mixBlendMode: "screen",
          opacity: 0.55,
          WebkitMaskImage: "linear-gradient(to left, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 55%, rgba(0,0,0,0) 100%)",
          maskImage: "linear-gradient(to left, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 55%, rgba(0,0,0,0) 100%)",
        }}
      />
