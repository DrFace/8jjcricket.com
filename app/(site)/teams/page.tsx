...
export default function TeamsPage() {
  // ✅ Minimal fix: wrap the component that uses useSearchParams in Suspense
  return (
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-50 text-sm md:text-base mt-1 font-medium">
        ...
        {teams.length === 0 ? (
          <div className="rounded-2xl border border-white/20 bg-black/50 backdrop-blur-xl p-12 text-center shadow-2xl">
            ...
            <p className="text-sm text-sky-100/70 mb-4">
              The selected series may not have team data available yet
            </p>
            <button
